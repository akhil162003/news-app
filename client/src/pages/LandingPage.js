    ...
    <div className="h-screen flex items-center sm:flex-col">
      ...
      <div className={`w-1/2 px-10 space-y-5 sm:w-screen ${(showLoginForm || showRegisterForm) && 'sm:hidden'}`}>
        <h1>
          ...
          <b className="text-8xl text-gray-700">AGGREGATOR</b>
        </h1>
        <p className="text-lg">
         Aggregate news articles from various sources or categories.
      Allow users to filter, search, and personalize their news feed.
        </p>
